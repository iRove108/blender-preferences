...
kmi = km.keymap_items.new('view2d.zoom_out', 'MINUS', 'PRESS', oskey=True)
kmi = km.keymap_items.new('view2d.zoom_in', 'EQUAL', 'PRESS', oskey=True)
...
kmi_props_setattr(kmi.properties, 'delta', -1)
kmi = km.keymap_items.new('view3d.zoom', 'WHEELDOWNMOUSE', 'PRESS')
kmi_props_setattr(kmi.properties, 'delta', 1)
kmi = km.keymap_items.new('view3d.zoom', 'WHEELUPMOUSE', 'PRESS')
kmi_props_setattr(kmi.properties, 'delta', -1)
